...
class FirstPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        load = Image.open("bg1.jpg")
        photo = ImageTk.PhotoImage(load)
        label = tk.Label(self, image=photo)
        label.image=photo
        label.place(x=0,y=0)

        border = tk.LabelFrame(self, text="Login", bg="sky blue", bd=10, font=("Arial", 20))
        ...
        def verify():
            try:
                ...
                messagebox.showinfo("Error", "An error occured while trying to open a file")
            ...
            def check():
                if t1.get() != "" or t2.get() != "" or t3.get() != "":
                    if t2.get() == t3.get():
                        ...
                        messagebox.showinfo("Error", "Your password did not match!!")
                else:
        ...
        B2 = tk.Button(self, text="Register", font=("Arial", 15), bg='dark orange',command=register)
        B2.place(x=650, y=20)
